//
//  Product7Collection+SubProduct.swift
//
...
public extension Product7Collection {
  ...
  ///
  typealias SubProduct = Product7Collection<
    A.SubSequence,
    B.SubSequence,
    C.SubSequence,
    D.SubSequence,
  ...
  ///
  /// - returns: The product of the slices: `a[a] x b[b] x ... x g[g]` (etc.).
  ///
  @inlinable
  func subproduct(
    a: Range<A.Index>,
