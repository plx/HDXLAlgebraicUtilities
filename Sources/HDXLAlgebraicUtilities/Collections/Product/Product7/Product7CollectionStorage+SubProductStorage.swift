//
//  Product7CollectionStorage+SubProductStorage.swift
//
...
internal extension Product7CollectionStorage {
  ...
  @usableFromInline
  typealias SubProductStorage = Product7CollectionStorage<
    A.SubSequence,
    B.SubSequence,
    C.SubSequence,
    D.SubSequence,
  ...
  ///
  /// - returns: The product of the slices: `a[a] x b[b] ... x g[g]` (etc.).
  ///
  ...
  func subproduct(
    ...
    e: Range<E.Index>,
    f: Range<F.Index>,
    g: Range<G.Index>) -> SubProductStorage {
