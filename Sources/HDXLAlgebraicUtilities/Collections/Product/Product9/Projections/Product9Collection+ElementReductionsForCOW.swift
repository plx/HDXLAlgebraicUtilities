//
//  Product9Collection+ElementReductionsForCOW.swift
//  
...
// -------------------------------------------------------------------------- //
// MARK: Product9Collection - Single-Element Reduction - COW
// -------------------------------------------------------------------------- //

public extension Product9Collection
  where
  Position == COWPositionRepresentation {
  ...
  func reducingA(to a: A.Index) -> Product9Collection<
    ...
    H,
    I,
    COWProduct9<CollectionOfOne<A.Element>.Index,B.Index,C.Index,D.Index,E.Index,F.Index,G.Index,H.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingB(to b: B.Index) -> Product9Collection<
    ...
    H,
    I,
    COWProduct9<A.Index,CollectionOfOne<B.Element>.Index,C.Index,D.Index,E.Index,F.Index,G.Index,H.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingC(to c: C.Index) -> Product9Collection<
    ...
    H,
    I,
    COWProduct9<A.Index,B.Index,CollectionOfOne<C.Element>.Index,D.Index,E.Index,F.Index,G.Index,H.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingD(to d: D.Index) -> Product9Collection<
    ...
    H,
    I,
    COWProduct9<A.Index,B.Index,C.Index,CollectionOfOne<D.Element>.Index,E.Index,F.Index,G.Index,H.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingE(to e: E.Index) -> Product9Collection<
    ...
    H,
    I,
    COWProduct9<A.Index,B.Index,C.Index,D.Index,CollectionOfOne<E.Element>.Index,F.Index,G.Index,H.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingF(to f: F.Index) -> Product9Collection<
    ...
    H,
    I,
    COWProduct9<A.Index,B.Index,C.Index,D.Index,E.Index,CollectionOfOne<F.Element>.Index,G.Index,H.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingG(to g: G.Index) -> Product9Collection<
    ...
    H,
    I,
    COWProduct9<A.Index,B.Index,C.Index,D.Index,E.Index,F.Index,CollectionOfOne<G.Element>.Index,H.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingH(to h: H.Index) -> Product9Collection<
    ...
    I,
    COWProduct9<A.Index,B.Index,C.Index,D.Index,E.Index,F.Index,G.Index,CollectionOfOne<H.Element>.Index,I.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
  ...
  func reducingI(to i: I.Index) -> Product9Collection<
    ...
    COWProduct9<A.Index,B.Index,C.Index,D.Index,E.Index,F.Index,G.Index,H.Index,CollectionOfOne<I.Element>.Index>,
    Element> {
      // ///////////////////////////////////////////////////////////////////////
