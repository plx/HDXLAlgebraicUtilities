//
//  ProductCollection9Storage+SubProduct.swift
//
...
internal extension Product9CollectionStorage {
  ...
  @usableFromInline
  typealias SubProductStorage = Product9CollectionStorage<
    A.SubSequence,
    B.SubSequence,
    C.SubSequence,
    D.SubSequence,
  ...
  ///
  /// - returns: The product of the slices: `a[a] x b[b] ... x i[i]` (etc.).
  ///
  ...
  func subproduct(
    ...
    g: Range<G.Index>,
    h: Range<H.Index>,
    i: Range<I.Index>) -> SubProductStorage {
...
// -------------------------------------------------------------------------- //
// MARK: SubProductStorage - Single-Axis API - I
// -------------------------------------------------------------------------- //

internal extension Product9CollectionStorage {
  
  /// Returns storage for a subproduct wherein we only slice along the `i`-axis.
  ///
  /// - parameter i: The range with-which to slice the `i`-factor.
  ///
  ...
  ///
  @inlinable
  func subproduct(i: Range<I.Index>) -> SubProductStorage {
    return SubProductStorage(
      self.a.completeSubSequence,
      self.b.completeSubSequence,
      self.c.completeSubSequence,
