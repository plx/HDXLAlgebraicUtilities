//
//  Product6Collection+SubProduct.swift
//
...
public extension Product6Collection {
  ...
  ///
  typealias SubProduct = Product6Collection<
    A.SubSequence,
    B.SubSequence,
    C.SubSequence,
    D.SubSequence,
  ...
  ///
  /// - returns: The product of the slices: `a[a] x b[b] x ... x f[f]` (etc.).
  ///
  @inlinable
  func subproduct(
    a: Range<A.Index>,
